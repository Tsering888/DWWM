-- le script Gescom générique proposé dans l'exercice 1
--
...
-- les fichiers des différentes tables importées et exportées (exercices 3 et 4)
...
--le script d'insertion de jeux de test pour les tables categories, customers, employees, orders, posts, suppliers (3 enregistrements par table minimum)
...
--
-- Hôte : localhost:3306
-- Généré le : jeu. 15 juil. 2021 à 11:02
...
(1, 'Outillage manuel', NULL),
(2, 'Outillag mécanique', NULL),
(3, 'Plant set Semis', NULL);
...
CREATE TABLE `employees` (
  ...
  `emp_gender` char(1) NOT NULL,
  `emp_children` tinyint(2) NOT NULL,
  `emp_sho_id` int(11) DEFAULT NULL,
...
(1, 17, 5, 'MOLETTE', 'Denis', '27 avenue Paul Lepoulpe', '80000', 'Amiens', 'dmolette@blabla.fr', 102030405, 18473, '2020-05-05', 'M', 8, 1, 4),
(2, 3, 2, 'NAGER', 'Emma', '14 rue Tabaga', '80300', 'Albert', 'emmanager@laposte.net', 102030405, 39576, '2015-03-27', 'F', 0, 1, 6),
(3, NULL, 1, 'LEBOSSE', 'Hugo', '28 mail Ludovic Cruchot', '75001', 'Paris', 'leboss@jarditou.com', 102030405, 350001, '2000-01-01', 'M', 2, 1, 8),
(4, 17, 6, 'LAPAGE', 'Edith', '22 rue Stevy Boulay', '60300', 'Senlis', 'lapage60300@yahoo.fr', 102030405, 18473, '2012-12-01', 'F', 1, 1, 6),
(5, 3, 35, 'DRESSAMERE', 'Yvan', '224 avenue Caumartin', '75009', 'Paris', 'yvan75009@outlook.com', 102030405, 39576, '2007-11-04', 'M', 0, 1, 6),
(6, 5, 3, 'MERCE', 'Coco', '56 cours Loana', '02000', 'Laon', 'merce@wazaa.net', 102030405, 30000, '2010-07-31', 'F', 2, 1, 6),
(7, 2, 3, 'AMAR', 'Yann', '4 rue du papillon de lumière', '62000', 'Arras', 'amar@azerty.com', 102030405, 30000, '2008-05-28', 'M', 3, 2, 6);
...
--
ALTER TABLE `orders`
  MODIFY `ord_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `posts`
  MODIFY `pos_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
