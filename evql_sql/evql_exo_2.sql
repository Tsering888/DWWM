...
-- cat_id est le PRIMARY KEY et cat_parent_id est le foreign key qui fait de reference à cat_id.
-- --------------------------------------------------------
...
-- cus_id est le primary key et cus_countries_id est le foreign key qui fait de refereznce à cus_id.
-- --------------------------------------------------------
...
--  emp_id est le primary key et emp_superrior_id est le foreign key qui fait de reference à emp_id.
